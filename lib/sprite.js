...
Sprite.prototype.make = function(images) {
    ...
    return this
        ...
        .then(function(imagesByUrl) {
            _this.mapper.fitter = _this.mapper.mapImages(imagesByUrl);
            _this.images = imagesByUrl;
        ...
        _emptySprite : {
            get : function() {
                return [
                    ...
                    "-size", this._width + "x" + this._height, "xc:none"
                ];
            },
            enumerable : true
        }

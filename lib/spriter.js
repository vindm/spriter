...
Spriter.make = function(config) {
    ...
    if (images.length === 0) {
        throw('Require at least one image to make sprite');
    }
...
Spriter.prototype.write = function(images) {
    ...
    config.images = images.sort(function(a, b) { return a.num - b.num; });
    ...
    return promise.promise()
        ...
        .fail(function() {
            Spriter.log(colors.red('Failed'), sprite.url);
        })
        .always(function() {
            return sprite;
        });
